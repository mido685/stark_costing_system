  ...
  if (!hasModule(module)) {
    return (
      <div className="flex flex-col items-center justify-center h-full py-24 text-center px-6">
        ...
        <h1 className="text-xl font-semibold text-foreground mb-1">Module not available</h1>
        <p className="text-sm text-muted-foreground max-w-sm">
          This feature isn't included in your company's current plan. Contact your administrator to enable it.
        </p>
      </div>
    );
  }
  ...
  return (
    <DashboardLayout onLogout={logout}>
      <Switch>
        ...
        <Route path="/masters">
          <RequireModule module="masters"><Masters /></RequireModule>
        </Route>
        <Route path="/inventory-controls">
          <RequireModule module="inventory"><InventoryControls /></RequireModule>
        </Route>
        <Route path="/procurement">
          <RequireModule module="procurement"><Procurement /></RequireModule>
        </Route>
        <Route path="/production">
          <RequireModule module="costing"><Production /></RequireModule>
        </Route>
        <Route path="/recipes">
          <RequireModule module="costing"><Recipes /></RequireModule>
        </Route>
        <Route path="/sales"              component={Sales}             />
        <Route path="/finance">
          <RequireModule module="finance"><Finance /></RequireModule>
        </Route>
        <Route path="/governance">
          <RequireModule module="governance"><Governance /></RequireModule>
        </Route>
        <Route path="/report">
          <RequireModule module="reports"><Report /></RequireModule>
        </Route>
        ...
        <RequireRole roles={["owner", "admin", "manager"]}>
          <RequireModule module="system_logs">
            <SystemLogsPage />
          </RequireModule>
        </RequireRole>
      </Route>
